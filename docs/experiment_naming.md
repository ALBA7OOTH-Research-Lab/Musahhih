...
| `F2` | Synthetic-data fine-tuning | `F2-P1`; training, checkpoint selection, and private development smoke complete; matched final-evaluation gate in preparation |
| `F3` | Mixed natural and synthetic fine-tuning | `F3-P1`; fixed 50:50 training, checkpoint selection, and private development smoke complete; matched final-evaluation gate in preparation |
