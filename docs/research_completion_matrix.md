...
| F2-P1/F3-P1 multi-seed robustness | Training complete; first evaluation attempt incomplete; repair prepared | `results/f2_f3_nautilus_multiseed_training_audit.md`; `docs/f2_f3_nautilus_multiseed_evaluation_protocol.md`; `docs/f2_f3_nautilus_evaluation_repair_protocol.md` | All five paired A100 training Jobs completed both arms. The first evaluation attempt durably preserved 3,739/5,110 outputs but produced no metric. No multi-seed accuracy or variance claim is allowed. | Merge issue #173, separately authorize and pass its non-test canary, then separately authorize exact-prefix continuation and the existing aggregation gate. |
