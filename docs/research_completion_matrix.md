...
| F2-P1/F3-P1 multi-seed robustness | Training complete; first evaluation attempt incomplete; first repair canary failed utilization; follow-up prepared | `results/f2_f3_nautilus_multiseed_training_audit.md`; `docs/f2_f3_nautilus_multiseed_evaluation_protocol.md`; `docs/f2_f3_nautilus_evaluation_repair_protocol.md`; `docs/f2_f3_nautilus_evaluation_utilization_repair_protocol.md` | All five paired A100 training Jobs completed both arms. The first evaluation attempt durably preserved 3,739/5,110 outputs but produced no metric. The batch-16 repair canary was not OOM-killed but failed the 40% mean-utilization gate. No multi-seed accuracy or variance claim is allowed. | Merge issue #175, separately authorize and pass its one non-test batch-64 canary, then separately authorize exact-prefix continuation and the existing aggregation gate. |
