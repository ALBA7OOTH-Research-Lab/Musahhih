...
| Fine-tuning versus five-shot B1-P1 | Incomplete | `results/b1_b2_qalb_dev_gpu_validation.md` | The 25-record development gate passed technically. | One frozen 511-record final run, after timeout-safe hardening and fresh authorization. |
| Fine-tuning versus expert-style B2-P1 | Incomplete | `results/b1_b2_qalb_dev_gpu_validation.md` | The 25-record development gate passed technically. | One frozen 511-record final run, after timeout-safe hardening and fresh authorization. |
