...
| F2-P1/F3-P1 multi-seed robustness | Training complete; evaluation prefixes preserved; concurrent repair prepared | `results/f2_f3_nautilus_multiseed_training_audit.md`; `docs/f2_f3_nautilus_multiseed_evaluation_protocol.md`; `docs/f2_f3_nautilus_evaluation_concurrency_protocol.md`; `results/f2_f3_nautilus_evaluation_concurrency_repair_audit.md` | All five paired A100 training Jobs completed both arms. The first evaluation attempt durably preserved 3,739/5,110 outputs but produced no metric. Batch 16 preserved synthetic single-record outputs but underutilized one A100; batch 64 changed outputs and was rejected. No multi-seed accuracy or variance claim is allowed. | Merge issue #177, separately authorize and pass its synthetic five-worker batch-16 canary, then separately authorize exact-prefix continuation and the existing aggregation gate. |
