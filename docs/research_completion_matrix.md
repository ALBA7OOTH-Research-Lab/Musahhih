...
| F2-P1/F3-P1 multi-seed robustness | Training complete; evaluation not executed | `results/f2_f3_nautilus_multiseed_training_audit.md` | All five paired A100 training Jobs completed both arms. No multi-seed accuracy or variance claim is yet allowed. | Review, freeze, and separately authorize private artifact audit plus matched evaluation/aggregation. |
