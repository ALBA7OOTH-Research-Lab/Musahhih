...
| F2-P1/F3-P1 multi-seed robustness | Five uniform-RTX-3090 evaluations complete; aggregate audit prepared | `results/f2_f3_nautilus_multiseed_training_audit.md`; `docs/f2_f3_nautilus_rtx3090_recovery_protocol.md`; `docs/f2_f3_rtx3090_aggregate_protocol.md` | All five paired training Jobs and all five clean record-zero RTX 3090 evaluation Jobs completed. The incomplete A100 prefixes remain excluded. Private results remain unread pending issue #185's CPU-only aggregate audit. | Merge issue #185, obtain one exact-commit aggregate GO, validate all ten files and paired statistics, then report the reviewed corpus-free cohort. |
