...
| F2-P1/F3-P1 multi-seed robustness | Training complete; evaluation prefixes preserved; MPS repair prepared | `results/f2_f3_nautilus_multiseed_training_audit.md`; `docs/f2_f3_nautilus_multiseed_evaluation_protocol.md`; `docs/f2_f3_nautilus_evaluation_mps_protocol.md`; `results/f2_f3_nautilus_mps_canary_repair_audit.md` | All five paired A100 training Jobs completed both arms. The first evaluation attempt durably preserved 3,739/5,110 outputs but produced no metric. Batch 64 changed outputs and was rejected. Five ordinary batch-16 processes preserved the correctness path but averaged 11.762% A100 utilization. No multi-seed accuracy or variance claim is allowed. | Merge issue #179, separately authorize and pass its NVIDIA MPS synthetic canary, then separately authorize exact-prefix continuation and the existing aggregation gate. |
