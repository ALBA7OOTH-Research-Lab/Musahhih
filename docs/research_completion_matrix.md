...
| Fine-tuning versus five-shot B1-P1 | Incomplete | `results/b1_b2_qalb_dev_gpu_validation.md` | The 25-record development gate passed technically; issue #107 implements timeout-safe continuation. | Merge and independently review the guard, then obtain a fresh exact-commit GO for one frozen 511-record final run. |
