...
| F2-P1/F3-P1 multi-seed robustness | Training complete; evaluation gate prepared but not executed | `results/f2_f3_nautilus_multiseed_training_audit.md`; `docs/f2_f3_nautilus_multiseed_evaluation_protocol.md` | All five paired A100 training Jobs completed both arms. No multi-seed accuracy or variance claim is yet allowed. | Merge the reviewed gate, then separately authorize test staging, five evaluations, and aggregation. |
