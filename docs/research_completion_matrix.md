...
| F2-P1/F3-P1 multi-seed robustness | Prepared; replacement training not authorized | `results/f2_f3_nautilus_fp16_trainer_smoke_audit.md` | The repaired A100 FP16 trainer stack constructed successfully without private data or an optimizer step. No multi-seed result is yet allowed. | Obtain a fresh exact-commit owner GO and complete the five frozen paired seed Jobs. |
