...
31.70\% exact accuracy versus 20.55\% for synthetic-only.  The pre-specified
...
For the pre-specified F3--F2 comparison, we report the accuracy difference,
...
We do not run QALB test, so our accuracy is not comparable to full-sentence M2
scores.
...
the simultaneously executed F3--F2 contrast is primary.  We exclude the
historical T4 Nahw baseline and all comparisons derived from it; every
displayed final-evaluation system ran on P100 hardware.
