...
SD 1.45).  Matched fixed-epoch gaps remain positive (6.11--6.58 points),
although development selection enlarges the mean separation.  Natural-only
reaches 28.38\%; the observed 3.33-point mixed
