...
that supervision composition materially affects this task.  Auxiliary
diagnostics expose a trade-off: synthetic-only preserves correct tokens more
often, whereas mixed scores 5.30 points higher on balanced ArabicMMLU.  Strict
...
adapters in one matched P100 run.  F2 leaves the designated correct token
